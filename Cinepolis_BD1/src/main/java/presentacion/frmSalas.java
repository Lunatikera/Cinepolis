...
public class frmSalas extends javax.swing.JFrame {
    ...
    public frmSalas(ISalaBO salaBO,int idSucursal) {
        initComponents();
        this.salaBO = salaBO;
    ...
    private void editar() throws NegocioException {
        ...
        if (id > 0)
        {
            ...
            FrmEditarSala editarSala = new FrmEditarSala(this.salaBO,id,this.idSucursal);
    ...
    private void BtnAgregarSalaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAgregarSalaActionPerformed
        ...
        FrmAgregarSala agregar = new FrmAgregarSala(this.salaBO,this.idSucursal);
